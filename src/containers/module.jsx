...
import { fetchModule, changeCoverage, requestcalculatePrice } from "../actions/modules";
...
class Module extends Component {
  ...
  handleClick(e) {
    this.props.requestcalculatePrice(this.props.module.coverage,this.props.module.risk);
  }
    ...
    return (
      <div class="contentDiv">
        ...
        />
          ...
          <div className='col-md-6'>
            <button className='btn btn-submit' onClick={this.handleClick}>Calculate</button>
          </div>
        </div>
        <div className='row'>
          <div className='col-md-6'>
...
function matchDispatchToProps(dispatch) {
  return bindActionCreators({ fetchModule, changeCoverage, requestcalculatePrice }, dispatch);
}
